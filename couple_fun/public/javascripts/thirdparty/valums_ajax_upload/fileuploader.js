...
qq.UploadHandlerForm.prototype = {
    ...
    _createForm: function(iframe, params){
        ...
        var form = qq.toElement('<form method="post" enctype="multipart/form-data"><input type="hidden" name="authenticity_token" value="'+window._token+'"/><input type="hidden" name="_format" value="json"/> </form>');
